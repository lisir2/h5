...
<template>
    <div class='JiaChengPay'>
        ...
        <van-action-sheet v-model="pay_Show" title="付款详情">
            ...
            <van-button type="primary" block style="margin-top:30px;" @click="policyPay">立即支付</van-button>
        </van-action-sheet>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        props:['payShow','orderNo','policyFee','goodName'],
        computed: {
