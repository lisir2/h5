...
<div>
    ...
    <div v-else class='examination'>
                    ...
                    <li v-for="item in holderList" :key="item.id">
                        ...
                        <span class="list_02">
                            ...
                            <div v-else-if="item.colcode === 'holderRelationship'">
                                ...
                                title="为谁投保"
                                />
                                <input type="text" placeholder="为谁投保" @click="show_insuredRelationship=true" :selectVal="insuredRelationship_val" id="holderRelationship" v-model="insuredRelationship_name" :name="item.colcode" readonly :ref="item.colcode">
                                <van-icon name="arrow"/>
                            </div>
        ...
        <div class="popbox_car" style="height: auto; width: 100%;display:none;">
            <div class="mainlist style-bf layer-xx">
                <h3>
                    重要告知
                    <a class="close-btn" id="product_car_close">&times;</a>
                </h3>
                <p>
                    亲爱的用户您好：
                </p>
                ...
                <div>
                    <a id="product_car_look">我再看看</a><a id="product_car_sure">我知道了</a>
                </div>
            </div>
        </div>
        <!-- 常用联系人 -->
...
export default {
  ...
  methods: {
    ...
    TypeSelect_holder(item) {
      ...
      this.typeSelectVal_holder = item.value;
      this.typeName_holder = item.name;
    ...
    onCheckPolicy() {
      ...
      $.each(this.holderList, function(index, ele) {
        if (ele.colcode == "holderSex") {
          ...
          // 投保人companyAttribute和taxpayerNo 放到投保人标的信息里面
        } else if (ele.colcode == "companyAttribute") {
      ...
      if ($("#time").val() == "") {
        ...
        // else if($('input[name=linkManCertificateNo]').val() == '' || isIdCard($('input[name=linkManCertificateNo]').val()) == false){
...
input[name="holderIdNumberSelect"] {
  width: 190px;
  height: 95px;
}
</style>