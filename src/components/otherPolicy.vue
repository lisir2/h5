...
<template>
    <div class='otherContent'>
        <p class="policyTitle">房屋信息</p>
        <ul>
            <li>
                <span class="list_01">房屋结构</span>
                <span class="list_02">
                    <!-- <select name="" id="">
                        <option value="">钢筋混凝土结构</option>
                    </select> -->
                    <input type="text" value="钢筋混凝土结构" readonly>
                    <van-icon name="arrow" />
                </span>
            </li>
            <li>
                 <span class="list_01">房屋年龄</span>
                <span class="list_02">
                    <input type="number" max="30" placeholder="请填写房屋年龄" class="houseAge">
                </span>
            </li>
            <li>
                <span class="list_01">房屋地址</span>
                <span class="list_02">
                    <input type="text" placeholder="请选择房屋地址" @click="showAddress" v-model="address" readonly>
                </span>
                <van-icon name="arrow" />
                <section class="showChose" v-show="showChose">
                    <section class="address">
                        <section class="title" id="firstTitle">
                            <h5>居住地址</h5>
                            <span @click="hideAddress">×</span>
                        </section>
                        <section class="title">
                        ...
                        <ul>
                            <li class="addList" v-for="(v,k) in info" @click="getProvinceId(v.id, v.name, k)" :key="v.a" v-show="showProvince" :class="v.selected ? 'active' : ''">{{v.name}}</li>
                            <li class="addList" v-for="(v,k) in showCityList" @click="getCityId(v.id, v.name, k)" :key="v.a" v-show="showCity" :class="v.selected ? 'active' : ''">{{v.name}}</li>
                            <li class="addList" v-for="(v,k) in showDistrictList" @click="getDistrictId(v.id, v.name, k)" :key="v.a" v-show="showDistrict" :class="v.selected ? 'active' : ''">{{v.name}}</li>
                        </ul>
                    </section>
                </section>
            </li>
            <li>
                ...
                <span class="list_02">
                    <input type="text" placeholder="请完善房屋详细地址" class="addressDetail">
                </span>
            </li>
        </ul>
    </div>
